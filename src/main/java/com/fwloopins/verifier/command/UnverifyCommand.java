...
public class UnverifyCommand implements TabExecutor {
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        user.data().remove(builder.build());
        luckPerms.getUserManager().saveUser(user);

        sender.sendMessage(Component.text("Successfully removed " + player.getName() + " as a builder", NamedTextColor.GREEN));
